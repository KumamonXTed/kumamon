...
for item in items:
	...
	if not nextday:
		...
		print"%s%s ,%s , %s%s , %s , %s(%s)->%s(%s)%s , %s(%s) , ￥%s"(item[0],item[1],item[11],item[2],item[3],item[12],item[5],item[4],item[10],nextday,item[8],item[7],item[6],item[13])